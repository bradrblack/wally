...
void clear() {
    ...
    delay(3);
    Serial1.printf("[");   delay(10);
    Serial1.printf("2");   delay(10);
    Serial1.printf("J");   delay(10);
    delay(10); 
...
void green(){
    ...
    Serial1.printf("%c", 0x1b);
   delay(5);
    Serial1.printf("[");   delay(3);
    Serial1.printf("1");   delay(3);
    Serial1.printf("%c", 0x3b);   delay(3);
      Serial1.printf("3");   delay(3);
        Serial1.printf("2");   delay(3);
          Serial1.printf("m");   delay(3);
